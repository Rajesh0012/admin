                ...
                <table id="myTable" class="table outlet-table table-striped table-hover">
                    ...
                    <?php if(!empty($userlist)) :?>
                        ...
                        <tr class="item">
                            ...
                            <td><?= ++$sno; ?></td>
                            <td><?php echo anchor(site_url().'Welcome/Qepr_admin/view_user_details/'.$users->id,isset($users->name)?$users->name:'') ?></td>
                            ...
                            <td>
                                <ul class="table-nav-list">
                                    <li><?= anchor(site_url().'Welcome/Qepr_admin/get_user/','<i class="fa fa-pencil"></i>','class="edit"') ?></li>
                                </ul>
                            </td>
                        </tr>
                        <?php endforeach; ?>
