                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="table-nav-list">
                                    <li><?= anchor(site_url().'admin/Cms_pageControlller/cms_pages?id=privacy_policy','<i class="fa fa-pencil"></i>','class="edit"') ?></li>
                                </ul>
                            </td>
                        </tr><tr>
                            ...
                            <td>
                                <ul class="table-nav-list">
                                    <li><?= anchor(site_url().'admin/Cms_pageControlller/cms_pages?id=contact_us','<i class="fa fa-pencil"></i>','class="edit"') ?></li>
                                </ul>
                            </td>
                        </tr><tr>
                            ...
                            <td>
                                <ul class="table-nav-list">
                                    <li><?= anchor(site_url().'admin/Cms_pageControlller/cms_pages?id=faq','<i class="fa fa-pencil"></i>','class="edit"') ?></li>
                                </ul>
                            </td>
                        </tr><tr>
                            ...
                            <td>
                                <ul class="table-nav-list">
                                    <li><?= anchor(site_url().'admin/Cms_pageControlller/cms_pages?id=term_and_condition','<i class="fa fa-pencil"></i>','class="edit"') ?></li>
                                </ul>
                            </td>
                        </tr><tr>
                            ...
                            <td>
                                <ul class="table-nav-list">
                                    <li><?= anchor(site_url().'admin/Cms_pageControlller/cms_pages?id=about_us','<i class="fa fa-pencil"></i>','class="edit"') ?></li>
                                </ul>
                            </td>
                        </tr><tr>
                            ...
                            <td>
                                <ul class="table-nav-list">
                                    <li><?= anchor(site_url().'admin/Cms_pageControlller/cms_pages?id=return_policy','<i class="fa fa-pencil"></i>','class="edit"') ?></li>
                                </ul>
                            </td>
                        </tr>
                    <?php endforeach; ?>
